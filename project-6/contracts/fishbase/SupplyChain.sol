...
// inherited contracts
import '../fishcore/Ownable.sol';
import '../fishaccesscontrol/FisherRole.sol';
import '../fishaccesscontrol/DistributorRole.sol';
import '../fishaccesscontrol/RetailerRole.sol';
import '../fishaccesscontrol/ConsumerRole.sol';
...
contract SupplyChain is Ownable, FisherRole, DistributorRole, RetailerRole, ConsumerRole {
  ...
  struct Item {
    ...
    string  originFisherLatitude; // Farm Latitude
    string  originFisherLongitude;  // Farm Longitude
  ...
  // Define a function 'fishItem' that allows a fisher to mark an item 'Fished'
  function fishItem(uint _upc, address _originFisherID, string _originFisherName, string _originFisherInformation, 
    string  _originFisherLatitude, string  _originFisherLongitude, string  _productNotes) public 
    onlyFisher()
  {
    // Add the new item as part of Fishing
    Item memory fish = Item({
      sku: skunit,
      upc: _upc,
      ownerID: _originFisherID,
      originFisherID: _originFisherID,
  ...
  // Define a function 'processtItem' that allows a fisher to mark an item 'Processed'
  ...
  // Define a function 'packItem' that allows a fisher to mark an item 'Packed'
    ...
    checkValue(_upc)
  {
    ...
    items[_upc].originFisherID.transfer(msg.value); 
  ...
  string  originFisherName,
  string  originFisherInformation,
  string  originFisherLatitude,
  string  originFisherLongitude
  ) 
  {
